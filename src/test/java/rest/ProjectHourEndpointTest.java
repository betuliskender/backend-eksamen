...
public class ProjectHourEndpointTest {
    ...
    public void testServerIsUp() {
        ...
        given().when().get("/hour").then().statusCode(200);
    }
    ...
    public void getAll() {
        ...
        projectHourDtos = given()
                .contentType("application/json")
                .when()
                .get("/hour")
                .then()
                .extract().body().jsonPath().getList("", ProjectHourDto.class);

        ProjectHourDto ph1Dto = new ProjectHourDto(ph1);
        assertThat(projectHourDtos, containsInAnyOrder(ph1Dto)) ;
    }
}
